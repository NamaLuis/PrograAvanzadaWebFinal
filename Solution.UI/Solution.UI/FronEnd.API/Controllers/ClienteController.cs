...
namespace FrontEnd.API.Controllers
{
    public class ClienteController : Controller
    {
        ...
        callapis.ProvinciaServicio provinciaservicios = new callapis.ProvinciaServicio();
        ...
        {
            ViewData["IdProvincia"] = new SelectList(provinciaservicios.GetAllAsync(), "IdProvincia", "NombreProvincia");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Cedula,Nombre,Apellido1,Apellido2,Idprovincia")] Models.Cliente cliente)
        {
            ...
            ViewData["IdProvincia"] = new SelectList(provinciaservicios.GetAllAsync(), "IdProvincia", "NombreProvincia", cliente.Idprovincia);
            return View(cliente);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cedula,Nombre,Apellido1,Apellido2,Idprovincia")] Models.Cliente cliente)
        {
