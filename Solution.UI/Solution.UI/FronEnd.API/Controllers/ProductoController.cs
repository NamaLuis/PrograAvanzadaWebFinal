...
namespace FrontEnd.API.Controllers
{
    public class ProductoController : Controller
    {
        ...
        callapis.ProveedorServicio proveedorservicios = new callapis.ProveedorServicio();
        ...
        {
            ViewData["IdProveedor"] = new SelectList(proveedorservicios.GetAllAsync(), "IdProveedor", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,NombreProducto,Cantidad,FechaIngreso,IdProveedor")] Models.Producto producto)
        {
            ...
            ViewData["IdProveedor"] = new SelectList(proveedorservicios.GetAllAsync(), "IdProveedor", "Nombre", producto.IdProveedor);
            return View(producto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,NombreProducto,Cantidad,FechaIngreso,IdProveedor")] Models.Producto producto)
        {
